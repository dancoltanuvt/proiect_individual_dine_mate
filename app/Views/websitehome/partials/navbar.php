<header id="header" class="header-scroll top-header headrom">
            ...
            <nav class="navbar navbar-dark">
                <div class="container">
                    ...
                    <a class="navbar-brand" href="index.html"> <img class="img-rounded" style="max-height:25px;" src="images/dinemate.png" alt=""> </a>
                    <div class="collapse navbar-toggleable-md  float-lg-right" id="mainNavbarCollapse">
                        <ul class="nav navbar-nav">
                            ...
                            <li class="nav-item dropdown"> <a class="nav-link dropdown-toggle" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">People</a>
                                <div class="dropdown-menu"> <a class="dropdown-item" href="restaurants.html">Food mate</a> <a class="dropdown-item" href="profile.html">People near me</a></div>
                            </li>
