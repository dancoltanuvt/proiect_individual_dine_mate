...
<?= $this->include('/websitehome/partials/header'); ?>

<body class="home">
    <div class="site-wrapper animsition" data-animsition-in="fade-in" data-animsition-out="fade-out">
        <!--header starts-->
        <?= $this->include('/websitehome/partials/navbar'); ?>

        <!-- banner part starts -->
        <section class="hero bg-image" data-image-src="images/home_banner_cleanup.png">
...
function sendPosition(position) {
    ...
    fetch('getLocationData', {
        ...
        headers: {
            ...
            'X-Requested-With': 'XMLHttpRequest' // This is to handle request as AJAX in CodeIgniter
        },
        body: JSON.stringify({ latitude: lat, longitude: lon })
    })
    .then(response => response.json())
    .then(data => {
        document.querySelector('.primary-color').textContent = data.location;
    })
...
window.onload = getLocation;
                    ...
                    <h1>Find your place & Enjoy your time</h1>
                    <h5 class="font-white space-xs">Find restaurants, offers, and friends for free!</h5>
                    <div class="banner-form">
                        <form class="form-inline">
                            <div class="form-group">
                                <label class="sr-only" for="exampleInputAmount">I would like to eat....</label>
                                <div class="form-group">
                                    <input type="text" class="form-control form-control-lg" id="foodInput" placeholder="I would like to eat...."> </div>
                                    <div id="autocompleteList" class="autocomplete-items"></div>

                            </div>
                            <button onclick="location.href='/restaurants'" type="button" class="btn theme-btn btn-lg">Search food</button>
                        </form>
                    </div>
                    <div class="steps">
                        ...
                        <div class="step-item step3">
                            ...
                            <h4><span>3. </span>Enjoy your time!</h4> </div>
                        <!-- end:Step -->
                    </div>
                    <!-- end:Steps -->
                </div>
        ...
        <div class="location-match text-xs-center">
            <div class="container"> <span>356 restaurants near your location: <span class="primary-color"></span> </span>
            </div>
        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-4 food-item">
                        <div class="food-item-wrap">
                            <div class="figure-wrap bg-image" data-image-src="/images/crispysharoma.jpeg">
                                <div class="distance"><i class="fa fa-pin"></i>1240m</div>
                                <div class="rating pull-left"> <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star-o"></i> </div>
                                <div class="review pull-right"><a href="#">198 reviews</a> </div>
                            </div>
                            <div class="content">
                                <h5><a href="profile.html">Crispy Shaorma + racoritoare</a></h5>
                                <div class="product-name">People recommend KFC's crispy shaorma!</div>
                                <div class="price-btn-block"> <span class="price">19.90 RON</span> <a href="#" class="btn theme-btn-dash pull-right">Go alone</a> <a href="#" class="btn theme-btn-dash pull-right mr-2">Find a mate</a></div>
                            </div>
                            <div class="restaurant-block">
                                <div class="left">
                                    <a class="pull-left" href="profile.html"> <img style="width:50px; height:45px;" src="/images/kfclogo.svg" alt="Restaurant logo" /> </a>
                                    <div class="pull-left right-text"> <a href="#">KFC</a> <span> Strada Johann Wolfgang von Goethe 2</span> </div>
                                </div>
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-4 food-item">
                        <div class="food-item-wrap">
                            <div class="figure-wrap bg-image" data-image-src="/images/smartbites.jpg">
                                <div class="distance"><i class="fa fa-pin"></i>1240m</div>
                                <div class="rating pull-left"> <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star-o"></i> </div>
                                <div class="review pull-right"><a href="#">198 reviews</a> </div>
                            </div>
                            <div class="content">
                                <h5><a href="profile.html">Meniu Smart Bites</a></h5>
                                <div class="product-name">People recommend KFC's Smart Bites Menu!</div>
                                <div class="price-btn-block"> <span class="price">28.00 RON</span> <a href="#" class="btn theme-btn-dash pull-right">Go alone</a> <a href="#" class="btn theme-btn-dash pull-right mr-2">Find a mate</a></div>
                            </div>
                            <div class="restaurant-block">
                                <div class="left">
                                <a class="pull-left" href="profile.html"> <img style="width:50px; height:45px;" src="/images/kfclogo.svg" alt="Restaurant logo" /> </a>
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-4 food-item">
                        <div class="food-item-wrap">
                        <div class="figure-wrap bg-image" data-image-src="/images/nonspicybucket.jpg">
                                <div class="distance"><i class="fa fa-pin"></i>1240m</div>
                                <div class="rating pull-left"> <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star-o"></i> </div>
                                <div class="review pull-right"><a href="#">198 reviews</a> </div>
                            </div>
                            <div class="content">
                                <h5><a href="profile.html">Non-spicy Bucket</a></h5>
                                <div class="product-name">People recommend KFC's Non-spicy Bucket!</div>
                                <div class="price-btn-block"> <span class="price">49.50 RON</span> <a href="#" class="btn theme-btn-dash pull-right">Go alone</a> <a href="#" class="btn theme-btn-dash pull-right mr-2">Find a mate</a></div>
                            </div>
                            <div class="restaurant-block">
                                <div class="left">
                                <a class="pull-left" href="profile.html"> <img style="width:50px; height:45px;" src="/images/kfclogo.svg" alt="Restaurant logo" /> </a>
                    ...
                    <div class="row how-it-works-solution">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col2">
                            <div class="step step-2">
                                ...
                                <h3>Invite someone to go with</h3>
                                <p>We"ve got your covered with menus from over 345 users online in your area.</p>
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col3">
                            <div class="step step-3">
                                ...
                                <h3>Enjoy your food and time together!</h3>
                                <p>Meet your dine mate at the restaurant and enjoy your time!</p>
                            </div>
                        </div>
                    </div>
                </div>
...
.autocomplete-items div:hover {
    background-color: #e9e9e9; 
        ...
        <?= $this->include('/websitehome/partials/footer'); ?>
<script>
document.getElementById('foodInput').addEventListener('input', function() {
    ...
    // Example data - replace this with actual data source
    var suggestions = ["Pizza", "Pasta", "Burger", "Sushi", "Salad"];

    suggestions.forEach(function(item) {
        if (item.substr(0, input.length).toUpperCase() == input.toUpperCase()) {
            var div = document.createElement("div");
            div.innerHTML = "<strong>" + item.substr(0, input.length) + "</strong>";
            div.innerHTML += item.substr(input.length);
            div.addEventListener("click", function() {
                document.getElementById('foodInput').value = item;
                autocompleteList.innerHTML = '';
            });
